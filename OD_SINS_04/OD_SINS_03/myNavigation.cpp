...
int attupdate()
{
	matstk *mas = matmas_init(10);
	matrix *phi = matmas_calloc(3,1,mas);
	matrix *dphi = matmas_calloc(3,1,mas);
	matrix *wnints = matmas_calloc(3,1,mas);
	matrix *qbb = matmas_calloc(4,1,mas);
	matrix *qnn = matmas_calloc(4,1,mas);
...
int vnupdate()
{
	matstk *mas = matmas_init(16);
	matrix* vm1 = matmas_calloc(3,1,mas);
	matrix* vm2 = matmas_calloc(3,1,mas);
	matrix* cm1 = matmas_calloc(3,1,mas);
	matrix* cm2 = matmas_calloc(3,1,mas);
	matrix *rotm = matmas_calloc(3,1,mas);
	matrix *rotm_half = matmas_calloc(3,1,mas);
	matrix *scullm = matmas_calloc(3,1,mas);
	matrix *gccts = matmas_calloc(3,1,mas);
	matrix *wnints2 = matmas_calloc(3,1,mas);
	matrix *qnn = matmas_calloc(4,1,mas);
